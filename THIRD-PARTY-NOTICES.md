...
PDFturbo includes the following open-source software. Full license texts are available in each package's repository.
...
Copyright (c) Cantoo Scribe — based on original pdf-lib by Andrew Dillon
